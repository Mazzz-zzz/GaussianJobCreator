...
label = '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R'
logfile = '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.663606), np.float64(0.065837), np.float64(-0.088265)], [np.float64(0.495794), np.float64(0.788665), np.float64(0.839174)], [np.float64(2.219289), np.float64(-0.717888), np.float64(0.797263)], [np.float64(0.923951), np.float64(-0.661799), np.float64(-0.881836)], [np.float64(1.182998), np.float64(2.672009), np.float64(0.410487)], [np.float64(0.773026), np.float64(3.127979), np.float64(-0.862625)], [np.float64(2.246643), np.float64(1.071678), np.float64(-0.505051)], [np.float64(2.327376), np.float64(3.00669), np.float64(1.168925)], [np.float64(0.119412), np.float64(2.816819), np.float64(1.231466)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R', 'label': '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R_prod'
    logfile = '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R_prod', 'label': '1502984102222700000001_r13_insertion_RSR_2_1_7_5_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
