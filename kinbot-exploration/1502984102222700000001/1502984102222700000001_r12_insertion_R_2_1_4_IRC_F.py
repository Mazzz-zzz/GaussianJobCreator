...
label = '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F'
logfile = '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.373535), np.float64(2.432735), np.float64(0.821167)], [np.float64(0.163442), np.float64(2.846673), np.float64(0.575704)], [np.float64(2.055665), np.float64(3.364799), np.float64(1.403035)], [np.float64(1.039406), np.float64(1.468076), np.float64(2.123829)], [np.float64(1.449509), np.float64(-0.20086), np.float64(0.112338)], [np.float64(2.70272), np.float64(-0.827392), np.float64(-0.107714)], [np.float64(1.959364), np.float64(1.698853), np.float64(-0.010089)], [np.float64(0.362953), np.float64(-0.333409), np.float64(-0.792588)], [np.float64(1.123609), np.float64(0.3939), np.float64(1.501524)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F', 'label': '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F_prod'
    logfile = '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F_prod', 'label': '1502984102222700000001_r12_insertion_R_2_1_4_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
