...
label = '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R'
logfile = '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.135122), np.float64(1.968002), np.float64(1.407526)], [np.float64(-0.25442), np.float64(1.724647), np.float64(1.162938)], [np.float64(1.29372), np.float64(3.310947), np.float64(1.688087)], [np.float64(1.401244), np.float64(1.227987), np.float64(2.589814)], [np.float64(1.584465), np.float64(-0.391593), np.float64(-0.10773)], [np.float64(2.795405), np.float64(-1.210242), np.float64(0.498252)], [np.float64(1.911024), np.float64(1.577953), np.float64(0.354642)], [np.float64(1.198657), np.float64(-0.355203), np.float64(-1.64126)], [np.float64(0.449376), np.float64(-0.511943), np.float64(0.695211)]])

kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R', 'label': '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R_prod'
    logfile = '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R_prod', 'label': '1502984102222700000001_R_Addition_MultipleBond_5_7_1_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
