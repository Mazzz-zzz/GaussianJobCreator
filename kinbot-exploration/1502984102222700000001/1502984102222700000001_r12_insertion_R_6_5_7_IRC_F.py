...
label = '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F'
logfile = '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.460247), np.float64(2.300675), np.float64(1.272282)], [np.float64(0.689006), np.float64(1.656537), np.float64(2.127472)], [np.float64(0.734873), np.float64(3.247028), np.float64(0.701882)], [np.float64(2.454888), np.float64(2.858219), np.float64(1.915604)], [np.float64(1.380065), np.float64(0.023498), np.float64(-0.09113)], [np.float64(1.419981), np.float64(-0.826041), np.float64(1.041321)], [np.float64(1.975397), np.float64(1.480009), np.float64(0.303471)], [np.float64(2.023063), np.float64(-0.276599), np.float64(-1.314986)], [np.float64(0.092679), np.float64(0.380055), np.float64(-0.328711)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F', 'label': '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F_prod'
    logfile = '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F_prod', 'label': '1502984102222700000001_r12_insertion_R_6_5_7_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
