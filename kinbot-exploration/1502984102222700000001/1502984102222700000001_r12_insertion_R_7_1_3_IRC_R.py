...
label = '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R'
logfile = '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.720925), np.float64(2.171827), np.float64(1.318126)], [np.float64(0.977157), np.float64(2.141359), np.float64(2.386677)], [np.float64(0.530488), np.float64(2.450857), np.float64(0.202863)], [np.float64(2.358916), np.float64(3.294641), np.float64(1.249307)], [np.float64(1.159856), np.float64(-0.103292), np.float64(-0.078883)], [np.float64(0.616077), np.float64(-0.972427), np.float64(0.904015)], [np.float64(2.309195), np.float64(1.130308), np.float64(0.941148)], [np.float64(2.067315), np.float64(-0.552413), np.float64(-1.072038)], [np.float64(0.490277), np.float64(1.282511), np.float64(-0.22401)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R', 'label': '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R_prod'
    logfile = '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R_prod', 'label': '1502984102222700000001_r12_insertion_R_7_1_3_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
