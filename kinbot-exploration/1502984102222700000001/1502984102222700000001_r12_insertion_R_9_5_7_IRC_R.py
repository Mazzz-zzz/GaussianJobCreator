...
label = '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R'
logfile = '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.409249), np.float64(2.371428), np.float64(1.177835)], [np.float64(0.770894), np.float64(2.636468), np.float64(2.296091)], [np.float64(1.47979), np.float64(3.472162), np.float64(0.462476)], [np.float64(2.629181), np.float64(1.965635), np.float64(1.464601)], [np.float64(1.29847), np.float64(-0.020504), np.float64(0.042289)], [np.float64(1.485093), np.float64(-0.814163), np.float64(1.202821)], [np.float64(0.702261), np.float64(1.427294), np.float64(0.474413)], [np.float64(2.316951), np.float64(0.164423), np.float64(-0.927235)], [np.float64(0.138317), np.float64(-0.359365), np.float64(-0.566087)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R', 'label': '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R_prod'
    logfile = '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R_prod', 'label': '1502984102222700000001_r12_insertion_R_9_5_7_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
