...
label = '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F'
logfile = '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.326549), np.float64(2.399399), np.float64(1.095827)], [np.float64(0.40903), np.float64(1.953506), np.float64(1.965671)], [np.float64(1.022416), np.float64(3.657746), np.float64(0.815038)], [np.float64(2.498648), np.float64(2.382563), np.float64(1.713253)], [np.float64(1.391764), np.float64(-0.371137), np.float64(0.011188)], [np.float64(1.661182), np.float64(-0.769527), np.float64(1.345082)], [np.float64(1.350634), np.float64(1.660405), np.float64(-0.019462)], [np.float64(2.223679), np.float64(-0.692012), np.float64(-1.089475)], [np.float64(0.346298), np.float64(0.622429), np.float64(-0.209919)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F', 'label': '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F_prod'
    logfile = '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F_prod', 'label': '1502984102222700000001_r12_insertion_R_7_5_9_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
