...
mol = Atoms(symbols=[np.str_('F'), np.str_('H')], positions=[[np.float64(-0.46063), np.float64(1.630978), np.float64(-1.106957)], [np.float64(-0.597439), np.float64(0.78673), np.float64(-1.473262)]])
