...
mol = Atoms(symbols=['C', 'F', 'F', 'F', 'S', 'O', 'O', 'O', 'H'], positions=[[-0.120384, -0.03864, 0.102358], [-0.653144, 0.692174, -0.847842], [-0.629548, 0.2972, 1.264619], [-0.34253, -1.310737, -0.133036], [1.725741, 0.25157, 0.147528], [2.248153, -0.556365, 1.184697], [2.202348, 0.094505, -1.267477], [1.909004, 1.741602, 0.16346], [2.283653, 1.354987, -1.008054]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984803620600000001_intra_H_migration_5_9_IRC_R', 'label': '1502984803620600000001_intra_H_migration_5_9_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    ...
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984803620600000001_intra_H_migration_5_9_IRC_R_prod', 'label': '1502984803620600000001_intra_H_migration_5_9_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
