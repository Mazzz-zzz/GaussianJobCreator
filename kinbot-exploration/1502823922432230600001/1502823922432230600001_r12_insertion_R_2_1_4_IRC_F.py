...
label = '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F'
logfile = '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.599701), np.float64(0.20559), np.float64(1.249371)], [np.float64(-1.515465), np.float64(-0.619231), np.float64(0.756062)], [np.float64(-1.219739), np.float64(1.135039), np.float64(1.963795)], [np.float64(0.153771), np.float64(-0.510093), np.float64(2.100181)], [np.float64(1.713304), np.float64(-0.259517), np.float64(-0.756682)], [np.float64(1.574524), np.float64(-0.099551), np.float64(-2.163139)], [np.float64(0.127047), np.float64(0.74877), np.float64(0.280128)], [np.float64(2.342128), np.float64(0.948921), np.float64(-0.094193)], [np.float64(1.334488), np.float64(1.209034), np.float64(0.418301)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F', 'label': '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F_prod'
    logfile = '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F_prod', 'label': '1502823922432230600001_r12_insertion_R_2_1_4_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
