...
label = '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R'
logfile = '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.700822), np.float64(-0.115403), np.float64(1.247614)], [np.float64(-1.982399), np.float64(-0.153993), np.float64(0.974536)], [np.float64(-0.480227), np.float64(0.816203), np.float64(2.165997)], [np.float64(-0.335963), np.float64(-1.279674), np.float64(1.767947)], [np.float64(1.630413), np.float64(0.344704), np.float64(0.163048)], [np.float64(1.990027), np.float64(-0.052241), np.float64(-1.251555)], [np.float64(-0.030757), np.float64(0.148387), np.float64(0.096024)], [np.float64(1.813765), np.float64(1.816644), np.float64(-0.138456)], [np.float64(2.00632), np.float64(1.234337), np.float64(-1.27133)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R', 'label': '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R_prod'
    logfile = '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R_prod', 'label': '1502823922432230600001_r12_insertion_R_6_5_7_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
