...
label = '1502823922432230600001_intra_H_migration_5_9_IRC_F'
logfile = '1502823922432230600001_intra_H_migration_5_9_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.717241), np.float64(0.064616), np.float64(1.086009)], [np.float64(-1.415623), np.float64(0.643221), np.float64(0.118022)], [np.float64(-1.213318), np.float64(0.432115), np.float64(2.245656)], [np.float64(-0.837937), np.float64(-1.238252), np.float64(0.961818)], [np.float64(1.429715), np.float64(0.524074), np.float64(-0.365723)], [np.float64(1.142609), np.float64(-0.66359), np.float64(-1.094595)], [np.float64(0.591868), np.float64(0.45904), np.float64(1.058351)], [np.float64(2.815054), np.float64(0.719086), np.float64(0.165776)], [np.float64(2.115231), np.float64(1.81865), np.float64(-0.421495)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_intra_H_migration_5_9_IRC_F', 'label': '1502823922432230600001_intra_H_migration_5_9_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_intra_H_migration_5_9_IRC_F_prod'
    logfile = '1502823922432230600001_intra_H_migration_5_9_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_intra_H_migration_5_9_IRC_F_prod', 'label': '1502823922432230600001_intra_H_migration_5_9_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
