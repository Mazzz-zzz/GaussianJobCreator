...
label = '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R'
logfile = '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.46893), np.float64(-0.039742), np.float64(1.206009)], [np.float64(-1.502442), np.float64(-0.054505), np.float64(0.388514)], [np.float64(-0.144122), np.float64(1.21857), np.float64(1.444483)], [np.float64(-0.816272), np.float64(-0.611868), np.float64(2.337507)], [np.float64(1.592123), np.float64(-0.207652), np.float64(-0.496332)], [np.float64(0.761294), np.float64(0.763902), np.float64(-1.319486)], [np.float64(0.576393), np.float64(-0.754791), np.float64(0.688208)], [np.float64(2.390616), np.float64(0.924016), np.float64(0.120781)], [np.float64(1.521696), np.float64(1.521032), np.float64(-0.615867)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R', 'label': '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R_prod'
    logfile = '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R_prod', 'label': '1502823922432230600001_r12_insertion_R_9_8_5_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
