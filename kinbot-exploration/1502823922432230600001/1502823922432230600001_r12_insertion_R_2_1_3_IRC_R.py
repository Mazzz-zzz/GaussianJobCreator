...
label = '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R'
logfile = '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.613832), np.float64(-0.021767), np.float64(1.168411)], [np.float64(-1.906596), np.float64(-0.082673), np.float64(0.879968)], [np.float64(-0.427518), np.float64(1.075417), np.float64(1.919985)], [np.float64(-0.30773), np.float64(-1.067285), np.float64(1.927476)], [np.float64(2.189973), np.float64(0.587552), np.float64(0.008154)], [np.float64(2.963155), np.float64(-0.358612), np.float64(-0.719806)], [np.float64(0.125389), np.float64(0.001353), np.float64(0.065779)], [np.float64(1.450939), np.float64(1.552322), np.float64(-0.896122)], [np.float64(0.436578), np.float64(1.072659), np.float64(-0.600028)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R', 'label': '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R_prod'
    logfile = '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R_prod', 'label': '1502823922432230600001_r12_insertion_R_2_1_3_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
