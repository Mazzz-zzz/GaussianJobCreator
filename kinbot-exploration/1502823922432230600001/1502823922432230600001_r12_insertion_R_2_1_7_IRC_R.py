...
label = '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R'
logfile = '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.665661), np.float64(0.321246), np.float64(0.922154)], [np.float64(-0.638977), np.float64(-0.7143), np.float64(1.709408)], [np.float64(-1.679559), np.float64(0.330226), np.float64(0.143851)], [np.float64(-0.611736), np.float64(1.362526), np.float64(1.70019)], [np.float64(1.297763), np.float64(0.289363), np.float64(-0.893312)], [np.float64(0.507204), np.float64(1.4294), np.float64(-0.322599)], [np.float64(0.484151), np.float64(-0.827299), np.float64(-0.308948)], [np.float64(2.681657), np.float64(0.280292), np.float64(-0.07692)], [np.float64(2.535512), np.float64(0.287509), np.float64(0.879993)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R', 'label': '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R_prod'
    logfile = '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R_prod', 'label': '1502823922432230600001_r12_insertion_R_2_1_7_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
