...
label = '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F'
logfile = '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.705333), np.float64(-0.095893), np.float64(1.254983)], [np.float64(-1.993213), np.float64(-0.028653), np.float64(1.019809)], [np.float64(-0.399337), np.float64(0.740504), np.float64(2.238472)], [np.float64(-0.406022), np.float64(-1.320276), np.float64(1.667905)], [np.float64(1.622485), np.float64(0.305619), np.float64(0.140565)], [np.float64(1.928259), np.float64(-0.058891), np.float64(-1.295386)], [np.float64(-0.048993), np.float64(0.218225), np.float64(0.108207)], [np.float64(1.88946), np.float64(1.773943), np.float64(-0.111846)], [np.float64(2.023047), np.float64(1.224379), np.float64(-1.268889)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F', 'label': '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F_prod'
    logfile = '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F_prod', 'label': '1502823922432230600001_r12_insertion_R_8_5_6_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
