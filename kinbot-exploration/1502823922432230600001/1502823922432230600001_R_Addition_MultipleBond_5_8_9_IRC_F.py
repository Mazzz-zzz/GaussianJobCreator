...
label = '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F'
logfile = '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.828761), np.float64(-0.135247), np.float64(1.290777)], [np.float64(-2.201207), np.float64(-0.104803), np.float64(1.142715)], [np.float64(-0.454415), np.float64(0.812801), np.float64(2.265144)], [np.float64(-0.462485), np.float64(-1.388785), np.float64(1.821994)], [np.float64(1.693199), np.float64(0.196156), np.float64(0.170858)], [np.float64(2.061413), np.float64(-0.111399), np.float64(-1.446595)], [np.float64(-0.227808), np.float64(0.108745), np.float64(0.067164)], [np.float64(2.061089), np.float64(1.801053), np.float64(-0.198652)], [np.float64(2.206547), np.float64(1.237529), np.float64(-1.420913)]])

kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F', 'label': '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F_prod'
    logfile = '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F_prod', 'label': '1502823922432230600001_R_Addition_MultipleBond_5_8_9_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
