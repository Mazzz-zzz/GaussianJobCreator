...
label = '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R'
logfile = '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.646669), np.float64(-0.083747), np.float64(1.301604)], [np.float64(-1.847498), np.float64(0.406433), np.float64(1.521196)], [np.float64(0.052522), np.float64(-0.017879), np.float64(2.432871)], [np.float64(-0.762194), np.float64(-1.356694), np.float64(0.975818)], [np.float64(1.593415), np.float64(0.570646), np.float64(0.124542)], [np.float64(1.921909), np.float64(-0.758572), np.float64(-0.29773)], [np.float64(-0.072684), np.float64(0.645281), np.float64(0.313108)], [np.float64(1.406263), np.float64(1.499664), np.float64(-1.177799)], [np.float64(2.265294), np.float64(1.853828), np.float64(-1.439788)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R', 'label': '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R_prod'
    logfile = '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R_prod', 'label': '1502823922432230600001_r12_insertion_R_7_5_8_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
