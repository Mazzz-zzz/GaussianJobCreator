...
label = '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F'
logfile = '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.203115), np.float64(-0.421473), np.float64(1.086787)], [np.float64(-1.00093), np.float64(-0.720724), np.float64(0.102179)], [np.float64(-0.487945), np.float64(1.264355), np.float64(1.079033)], [np.float64(-0.765989), np.float64(-0.696114), np.float64(2.220352)], [np.float64(2.02175), np.float64(0.452231), np.float64(-0.520458)], [np.float64(1.358676), np.float64(0.022629), np.float64(-1.707212)], [np.float64(1.021225), np.float64(-0.571883), np.float64(0.974396)], [np.float64(1.503942), np.float64(1.758262), np.float64(0.001062)], [np.float64(0.462742), np.float64(1.67168), np.float64(0.517681)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F', 'label': '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F_prod'
    logfile = '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F_prod', 'label': '1502823922432230600001_r12_insertion_R_7_1_3_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
