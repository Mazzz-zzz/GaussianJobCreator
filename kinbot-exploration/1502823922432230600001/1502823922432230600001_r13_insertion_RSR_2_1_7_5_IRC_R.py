...
label = '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R'
logfile = '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.404627), np.float64(0.096185), np.float64(-0.230112)], [np.float64(0.069838), np.float64(0.078081), np.float64(-0.083038)], [np.float64(1.921203), np.float64(-0.462907), np.float64(0.85716)], [np.float64(1.693414), np.float64(-0.67393), np.float64(-1.270534)], [np.float64(1.175522), np.float64(3.054021), np.float64(0.665178)], [np.float64(2.275584), np.float64(3.803522), np.float64(1.166323)], [np.float64(1.867894), np.float64(1.328599), np.float64(-0.401972)], [np.float64(0.905755), np.float64(3.327821), np.float64(-0.800574)], [np.float64(1.272674), np.float64(2.2645), np.float64(-1.081002)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R', 'label': '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R_prod'
    logfile = '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R_prod', 'label': '1502823922432230600001_r13_insertion_RSR_2_1_7_5_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
