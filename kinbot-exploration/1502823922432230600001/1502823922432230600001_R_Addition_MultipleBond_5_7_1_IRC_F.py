...
label = '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F'
logfile = '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.010244), np.float64(-0.22593), np.float64(1.516774)], [np.float64(-0.6579), np.float64(1.009601), np.float64(1.66815)], [np.float64(1.017606), np.float64(-0.234331), np.float64(2.519178)], [np.float64(-0.905848), np.float64(-1.227229), np.float64(1.831343)], [np.float64(2.331637), np.float64(0.524443), np.float64(-0.087705)], [np.float64(2.861736), np.float64(-0.335345), np.float64(-1.285278)], [np.float64(0.523512), np.float64(-0.409489), np.float64(0.267238)], [np.float64(1.436258), np.float64(1.93946), np.float64(-0.692899)], [np.float64(0.578726), np.float64(1.676404), np.float64(-1.1186)]])

kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F', 'label': '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F_prod'
    logfile = '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F_prod', 'label': '1502823922432230600001_R_Addition_MultipleBond_5_7_1_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
