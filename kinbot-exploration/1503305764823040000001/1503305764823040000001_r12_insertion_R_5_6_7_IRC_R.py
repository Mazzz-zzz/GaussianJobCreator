...
label = '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R'
logfile = '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.082387), np.float64(0.035793), np.float64(0.004887)], [np.float64(-0.378927), np.float64(0.386365), np.float64(-1.186238)], [np.float64(-0.324227), np.float64(0.928141), np.float64(0.896935)], [np.float64(-0.425004), np.float64(-1.145278), np.float64(0.324304)], [np.float64(1.996955), np.float64(-0.103483), np.float64(-0.086553)], [np.float64(2.116703), np.float64(-0.539333), np.float64(1.398015)], [np.float64(3.508804), np.float64(-0.235597), np.float64(0.920794)], [np.float64(2.142463), np.float64(1.469264), np.float64(-0.262477)], [np.float64(2.14091), np.float64(1.926176), np.float64(0.591906)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R', 'label': '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R_prod'
    logfile = '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R_prod', 'label': '1503305764823040000001_r12_insertion_R_5_6_7_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
