...
label = '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R'
logfile = '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.172489), np.float64(-0.065639), np.float64(0.114221)], [np.float64(-0.749875), np.float64(0.785793), np.float64(-0.698778)], [np.float64(-0.441766), np.float64(0.261977), np.float64(1.356865)], [np.float64(-0.641667), np.float64(-1.282312), np.float64(-0.120027)], [np.float64(1.709065), np.float64(-0.115209), np.float64(-0.327592)], [np.float64(2.056727), np.float64(0.472836), np.float64(1.185062)], [np.float64(3.473933), np.float64(0.409165), np.float64(1.301488)], [np.float64(1.895899), np.float64(0.936331), np.float64(-1.305235)], [np.float64(3.730238), np.float64(1.319107), np.float64(1.095566)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R', 'label': '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R_prod'
    logfile = '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R_prod', 'label': '1503305764823040000001_r12_insertion_R_9_8_5_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
