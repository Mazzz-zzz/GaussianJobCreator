...
label = '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R'
logfile = '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.427651), np.float64(-0.204813), np.float64(-0.160634)], [np.float64(0.230258), np.float64(0.338931), np.float64(0.016022)], [np.float64(1.706609), np.float64(-0.973929), np.float64(0.883977)], [np.float64(1.354845), np.float64(-0.965563), np.float64(-1.239679)], [np.float64(2.752469), np.float64(1.055408), np.float64(-0.267067)], [np.float64(0.864267), np.float64(3.394685), np.float64(1.11404)], [np.float64(1.03671), np.float64(4.060273), np.float64(0.125158)], [np.float64(2.196562), np.float64(1.906603), np.float64(-1.542898)], [np.float64(1.592725), np.float64(2.598605), np.float64(-1.236402)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R', 'label': '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R_prod'
    logfile = '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R_prod', 'label': '1503305764823040000001_r13_insertion_ROR_2_1_5_6_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
