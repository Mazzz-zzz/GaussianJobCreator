...
label = '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R'
logfile = '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.010247), np.float64(-0.018956), np.float64(0.046251)], [np.float64(-0.310835), np.float64(0.415353), np.float64(-1.165504)], [np.float64(-0.591418), np.float64(0.744794), np.float64(0.934239)], [np.float64(-0.419764), np.float64(-1.264005), np.float64(0.166093)], [np.float64(2.023002), np.float64(-0.029418), np.float64(0.085426)], [np.float64(1.883013), np.float64(-0.431754), np.float64(1.550222)], [np.float64(3.475059), np.float64(-0.192806), np.float64(0.730412)], [np.float64(1.973533), np.float64(1.56559), np.float64(-0.01908)], [np.float64(2.817221), np.float64(1.933253), np.float64(0.273513)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R', 'label': '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R_prod'
    logfile = '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R_prod', 'label': '1503305764823040000001_r12_insertion_R_6_5_7_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
