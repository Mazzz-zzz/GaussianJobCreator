...
label = '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R'
logfile = '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.082025), np.float64(0.037366), np.float64(0.0048)], [np.float64(-0.377875), np.float64(0.386239), np.float64(-1.18737)], [np.float64(-0.323378), np.float64(0.932449), np.float64(0.89465)], [np.float64(-0.427864), np.float64(-1.142014), np.float64(0.326477)], [np.float64(1.996365), np.float64(-0.105864), np.float64(-0.085169)], [np.float64(2.114357), np.float64(-0.538691), np.float64(1.40044)], [np.float64(3.50731), np.float64(-0.238646), np.float64(0.923402)], [np.float64(2.145038), np.float64(1.466209), np.float64(-0.264517)], [np.float64(2.144094), np.float64(1.924998), np.float64(0.588861)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R', 'label': '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R_prod'
    logfile = '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R_prod', 'label': '1503305764823040000001_r12_insertion_R_7_6_5_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
