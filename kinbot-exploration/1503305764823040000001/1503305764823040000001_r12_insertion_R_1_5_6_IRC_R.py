...
label = '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R'
logfile = '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.165959), np.float64(0.102997), np.float64(0.038747)], [np.float64(-0.320977), np.float64(0.476481), np.float64(-1.132123)], [np.float64(-0.16137), np.float64(1.021835), np.float64(0.943456)], [np.float64(-0.38474), np.float64(-1.045152), np.float64(0.382898)], [np.float64(2.063738), np.float64(-0.117301), np.float64(-0.099187)], [np.float64(2.069703), np.float64(-0.968194), np.float64(1.280684)], [np.float64(3.331768), np.float64(-0.219377), np.float64(0.996024)], [np.float64(2.210098), np.float64(1.483234), np.float64(-0.284076)], [np.float64(1.885883), np.float64(1.987527), np.float64(0.475147)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R', 'label': '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R_prod'
    logfile = '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R_prod', 'label': '1503305764823040000001_r12_insertion_R_1_5_6_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
