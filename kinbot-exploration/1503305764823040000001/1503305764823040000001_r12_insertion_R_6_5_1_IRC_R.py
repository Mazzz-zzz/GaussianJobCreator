...
label = '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R'
logfile = '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.147909), np.float64(0.03544), np.float64(0.01616)], [np.float64(-0.333739), np.float64(0.288738), np.float64(-1.184568)], [np.float64(-0.284021), np.float64(0.961872), np.float64(0.858383)], [np.float64(-0.253947), np.float64(-1.145084), np.float64(0.41762)], [np.float64(2.059144), np.float64(0.077781), np.float64(-0.080325)], [np.float64(2.295437), np.float64(-0.147166), np.float64(1.411017)], [np.float64(3.323519), np.float64(-1.168992), np.float64(0.922188)], [np.float64(2.152228), np.float64(1.665727), np.float64(-0.248265)], [np.float64(1.753536), np.float64(2.153733), np.float64(0.489366)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R', 'label': '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R_prod'
    logfile = '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R_prod', 'label': '1503305764823040000001_r12_insertion_R_6_5_1_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
