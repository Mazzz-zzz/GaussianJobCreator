...
label = '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F'
logfile = '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.171107), np.float64(0.081609), np.float64(0.032926)], [np.float64(-0.300277), np.float64(0.398992), np.float64(-1.16058)], [np.float64(-0.178156), np.float64(1.0359), np.float64(0.891272)], [np.float64(-0.375028), np.float64(-1.055595), np.float64(0.418459)], [np.float64(2.072221), np.float64(-0.12718), np.float64(-0.066347)], [np.float64(2.065031), np.float64(-0.9128), np.float64(1.351873)], [np.float64(3.323554), np.float64(-0.164043), np.float64(1.052108)], [np.float64(2.207456), np.float64(1.464353), np.float64(-0.325448)], [np.float64(1.874153), np.float64(2.000817), np.float64(0.407311)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F', 'label': '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F_prod'
    logfile = '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F_prod', 'label': '1503305764823040000001_r12_insertion_R_6_7_5_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
