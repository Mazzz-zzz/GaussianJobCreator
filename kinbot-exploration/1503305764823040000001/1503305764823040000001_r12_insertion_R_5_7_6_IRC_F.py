...
label = '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F'
logfile = '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.031986), np.float64(0.195227), np.float64(0.134267)], [np.float64(-0.467819), np.float64(0.343482), np.float64(-1.083414)], [np.float64(-0.131202), np.float64(1.329364), np.float64(0.800913)], [np.float64(-0.641325), np.float64(-0.762211), np.float64(0.754247)], [np.float64(1.876954), np.float64(-0.322166), np.float64(-0.012542)], [np.float64(3.430515), np.float64(-0.501871), np.float64(0.918221)], [np.float64(2.05956), np.float64(-0.414963), np.float64(1.526254)], [np.float64(2.273741), np.float64(1.110072), np.float64(-0.575892)], [np.float64(2.427655), np.float64(1.745118), np.float64(0.139526)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F', 'label': '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F_prod'
    logfile = '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F_prod', 'label': '1503305764823040000001_r12_insertion_R_5_7_6_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
