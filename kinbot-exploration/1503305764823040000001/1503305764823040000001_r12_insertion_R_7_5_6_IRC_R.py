...
label = '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R'
logfile = '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.010446), np.float64(-0.019022), np.float64(0.045375)], [np.float64(-0.309872), np.float64(0.415514), np.float64(-1.166502)], [np.float64(-0.591893), np.float64(0.744463), np.float64(0.933128)], [np.float64(-0.4195), np.float64(-1.264148), np.float64(0.164656)], [np.float64(2.023159), np.float64(-0.029288), np.float64(0.085869)], [np.float64(1.882317), np.float64(-0.432003), np.float64(1.550478)], [np.float64(3.474856), np.float64(-0.192608), np.float64(0.731738)], [np.float64(1.973584), np.float64(1.56574), np.float64(-0.018311)], [np.float64(2.816974), np.float64(1.933402), np.float64(0.275147)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R', 'label': '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R_prod'
    logfile = '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R_prod', 'label': '1503305764823040000001_r12_insertion_R_7_5_6_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
