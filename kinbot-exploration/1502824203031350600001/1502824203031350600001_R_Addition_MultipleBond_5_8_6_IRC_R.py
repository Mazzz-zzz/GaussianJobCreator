...
label = '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R'
logfile = '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(2.274036), np.float64(0.925463), np.float64(-2.521341)], [np.float64(1.551732), np.float64(-0.073635), np.float64(-3.132812)], [np.float64(3.142917), np.float64(0.41592), np.float64(-1.578347)], [np.float64(3.022215), np.float64(1.607194), np.float64(-3.48996)], [np.float64(1.067102), np.float64(2.317879), np.float64(-1.742508)], [np.float64(0.406505), np.float64(0.034018), np.float64(-0.428131)], [np.float64(-0.282857), np.float64(2.104919), np.float64(-2.541789)], [np.float64(1.052425), np.float64(1.43165), np.float64(0.005548)], [np.float64(0.501987), np.float64(-0.40234), np.float64(0.455476)]])

kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R', 'label': '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Read,Mix', 'geom': 'AllCheck,NoKeepConstants', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R_prod'
    logfile = '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'mp2', 'basis': '6-31G', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R_prod', 'label': '1502824203031350600001_R_Addition_MultipleBond_5_8_6_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'guess': 'Mix,Always', 'freq': 'freq', 'opt': 'CalcFC'}
