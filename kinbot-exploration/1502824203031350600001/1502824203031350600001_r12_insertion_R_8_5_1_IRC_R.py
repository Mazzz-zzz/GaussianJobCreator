...
label = '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R'
logfile = '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(2.208429), np.float64(0.902228), np.float64(-2.395137)], [np.float64(1.524824), np.float64(-0.227333), np.float64(-2.523648)], [np.float64(3.409565), np.float64(0.632051), np.float64(-1.930929)], [np.float64(2.312971), np.float64(1.473984), np.float64(-3.577622)], [np.float64(1.301752), np.float64(2.102086), np.float64(-1.227787)], [np.float64(0.498306), np.float64(0.064326), np.float64(0.177505)], [np.float64(-0.051476), np.float64(2.086422), np.float64(-1.750233)], [np.float64(1.410789), np.float64(1.160771), np.float64(0.095672)], [np.float64(0.303711), np.float64(-0.185729), np.float64(-0.739386)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R', 'label': '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,reverse,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R_prod'
    logfile = '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R_prod', 'label': '1502824203031350600001_r12_insertion_R_8_5_1_IRC_R_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
