...
label = '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F'
logfile = '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(1.520612), np.float64(3.628139), np.float64(-0.227922)], [np.float64(0.264533), np.float64(3.977093), np.float64(-0.109581)], [np.float64(1.902843), np.float64(3.707324), np.float64(-1.482159)], [np.float64(2.276351), np.float64(4.429714), np.float64(0.492049)], [np.float64(1.749118), np.float64(1.846536), np.float64(0.373656)], [np.float64(0.794731), np.float64(1.326009), np.float64(-1.052977)], [np.float64(1.74379), np.float64(2.362655), np.float64(1.959071)], [np.float64(0.327554), np.float64(1.196473), np.float64(0.359939)], [np.float64(1.123068), np.float64(1.864448), np.float64(2.501619)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F', 'label': '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=30,StepSize=10'}
...
if success:
    label = '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F_prod'
    logfile = '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F_prod', 'label': '1502663602461501180601_r12_insertion_R_1_7_5_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
