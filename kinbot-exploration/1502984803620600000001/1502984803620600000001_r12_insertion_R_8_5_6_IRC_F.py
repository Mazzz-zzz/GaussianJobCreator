...
label = '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F'
logfile = '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(-0.260403), np.float64(-0.086567), np.float64(-0.220143)], [np.float64(-0.345297), np.float64(0.552858), np.float64(-1.325437)], [np.float64(-0.916145), np.float64(0.527587), np.float64(0.718417)], [np.float64(-0.602885), np.float64(-1.321585), np.float64(-0.301348)], [np.float64(1.824182), np.float64(-0.030807), np.float64(0.405401)], [np.float64(3.214853), np.float64(0.006388), np.float64(0.822713)], [np.float64(1.78222), np.float64(-0.70716), np.float64(-0.900027)], [np.float64(1.538535), np.float64(1.56375), np.float64(0.236879)], [np.float64(2.38823), np.float64(2.021833), np.float64(0.169795)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F', 'label': '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F_prod'
    logfile = '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F_prod', 'label': '1502984803620600000001_r12_insertion_R_8_5_6_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
