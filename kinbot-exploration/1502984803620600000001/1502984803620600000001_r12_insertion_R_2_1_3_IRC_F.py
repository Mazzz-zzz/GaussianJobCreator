...
label = '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F'
logfile = '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F.log'

mol = Atoms(symbols=[np.str_('C'), np.str_('F'), np.str_('F'), np.str_('F'), np.str_('S'), np.str_('O'), np.str_('O'), np.str_('O'), np.str_('H')], positions=[[np.float64(0.199062), np.float64(-0.267444), np.float64(-0.460541)], [np.float64(-0.475334), np.float64(0.181941), np.float64(-1.414179)], [np.float64(-0.234015), np.float64(1.559095), np.float64(1.006527)], [np.float64(-0.433528), np.float64(-1.113006), np.float64(0.211065)], [np.float64(2.087887), np.float64(0.062611), np.float64(-0.247229)], [np.float64(2.210917), np.float64(-0.119845), np.float64(1.164069)], [np.float64(2.476761), np.float64(-1.009256), np.float64(-1.113592)], [np.float64(2.159676), np.float64(1.401073), np.float64(-0.740815)], [np.float64(0.631867), np.float64(1.831127), np.float64(1.20095)]])

kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F', 'label': '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'geom': 'AllCheck,NoKeepConstants', 'guess': 'Read', 'irc': 'RCFC,forward,MaxPoints=100,StepSize=2'}
...
if success:
    label = '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F_prod'
    logfile = '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F_prod.log'
    # start the product optimization
    prod_kwargs = {'method': 'bmk', 'basis': '6-31++G(2df,p)', 'nprocshared': 8, 'mem': '700MW', 'chk': '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F_prod', 'label': '1502984803620600000001_r12_insertion_R_2_1_3_IRC_F_prod', 'Symm': 'None', 'mult': 1, 'charge': 0, 'scf': 'xqc', 'pop': 'None', 'freq': 'freq', 'opt': 'CalcFC'}
